...
public class ProductController {
	...
	public ResponseEntity<ProductOutput> ceateProduct(@RequestBody @Valid ProductInput productInput, BindingResult bind) {
	...
	public ResponseEntity<ProductOutput> updateProduct(@RequestBody @Valid ProductInput productInput, @PathVariable int id, BindingResult bind) {
		validate.validate(productInput, bind);
