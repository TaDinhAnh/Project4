...
public class AuctionHistoryController {
	...
	public ResponseEntity<Boolean> create(@RequestBody @Valid AuctionHistoryInput auctionhistoryInput,
			BindingResult bind) {
	...
	public ResponseEntity<List<AuctionHistoryOutput>> findList() {
		...
		return new ResponseEntity<List<AuctionHistoryOutput>>(auctionHistoryOutputs, HttpStatus.OK);
	}
	...
	public ResponseEntity<Integer> countAuctionHistoryById(@PathVariable("id") int id) {
		if (id <= 0) {
