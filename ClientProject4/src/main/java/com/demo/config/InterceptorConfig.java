...
public class InterceptorConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(vendorInterceptor).addPathPatterns("/vendor/**")
				.excludePathPatterns("/customer/view/**", "/customer/account/signIn", "/customer/account/register", "/customer/account/changeInfor");
