...
<link rel="apple-touch-icon" sizes="76x76"
	href="${pageContext.request.contextPath }/resources/assets/admin/img/apple-icon.png">
<link rel="icon" type="image/png"
	href="${pageContext.request.contextPath }/resources/assets/admin/img/favicon.png">
<title>${title }</title>
<link
	href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700"
	rel="stylesheet" />
<link
	href="${pageContext.request.contextPath }/resources/assets/admin/css/nucleo-icons.css"
	rel="stylesheet" />

<link
	href="${pageContext.request.contextPath }/resources/assets/admin/css/nucleo-svg.css"
	rel="stylesheet" />
<link
	href="${pageContext.request.contextPath }/resources/assets/admin/css/nucleo-svg.css"
	rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
	<aside
		...
		<div class="sidenav-header">
			<i
				...
				target="_blank"> <img
				src="${pageContext.request.contextPath }/resources/assets/admin/img/logo-ct.png"
				class="navbar-brand-img h-100" alt="main_logo"> <span
				class="ms-1 font-weight-bold">Soft UI Dashboard</span>
			</a>
		</div>
   ...
   <path class="color-background opacity-6"
						...
						</div> <span class="nav-link-text ms-1">Accounts</span>
				</a></li>
				<li class="nav-item"><a class="nav-link  "
                  ...
                  <g transform="translate(-2319.000000, -291.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(603.000000, 0.000000)">
						...
						</div> <span class="nav-link-text ms-1">Products</span>
				</a></li>
				<li class="nav-item"><a class="nav-link  "
                  ...
                  <g transform="translate(-2319.000000, -291.000000)"
                    ...
                    <g transform="translate(1716.000000, 291.000000)">
                      <g transform="translate(603.000000, 0.000000)">
						...
						</div> <span class="nav-link-text ms-1">Categories</span>
				</a></li>
				<li class="nav-item"><a class="nav-link  "
					href="${pageContext.request.contextPath }/admin/table/index">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
							<svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
								xmlns="http://www.w3.org/2000/svg"
				...
				<li class="nav-item"><a class="nav-link  "
					href="${pageContext.request.contextPath }/admin/billing/index">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
				...
				<li class="nav-item"><a class="nav-link  "
					href="${pageContext.request.contextPath }/admin/virtualReality/index">
						<div
							class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
							<svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
								xmlns="http://www.w3.org/2000/svg"
		...
		<div class="sidenav-footer mx-3 ">
			<div
				...
				<div class="full-background"
					style="background-image: url('${pageContext.request.contextPath }/resources/assets/admin/img/curved-images/white-curved.jpeg')"></div>
						...
						<div class="col-lg-6 mb-lg-0 mb-4">
							<div
								...
								, made with <i class="fa fa-heart"></i> by <a
									href="https://www.facebook.com/beanhcute26"
									class="font-weight-bold" target="_blank">Quynh Anh</a> for a
								better web.
							</div>
						</div>
					</div>
	...
	<script
		src="${pageContext.request.contextPath }/resources/assets/admin/js/core/popper.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/assets/admin/js/core/bootstrap.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/assets/admin/js/plugins/perfect-scrollbar.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/assets/admin/js/plugins/smooth-scrollbar.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/resources/assets/admin/js/plugins/chartjs.min.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath }/resources/assets/admin/js/soft-ui-dashboard.min.js?v=1.0.3"></script>
	<script
