          ...
          <div class="col-lg-8">
            <div id="property-single-carousel" class="swiper">
              <div class="swiper-wrapper">
                ...
                <div class="carousel-item-b swiper-slide">
                  <img
										src="${pageContext.request.contextPath }/resources/assets/customer/img/slide-2.jpg"
										alt="">
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-10 offset-md-1">
            <ul class="nav nav-pills-a nav-pills mb-3 section-t3"
              ...
              <li class="nav-item">
                <a class="nav-link active" id="pills-video-tab"
								data-bs-toggle="pill" href="#pills-video" role="tab"
            ...
            <div class="tab-content" id="pills-tabContent">
              ...
              <div class="tab-pane fade" id="pills-plans"
                ...
                <img
									src="${pageContext.request.contextPath }/resources/assets/customer/img/plan2.jpg"
									alt="" class="img-fluid">
              </div>
