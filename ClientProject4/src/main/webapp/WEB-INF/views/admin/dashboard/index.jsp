              ...
              <div class="row">
                ...
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div
                    ...
                    <img
										src="${pageContext.request.contextPath }/resources/assets/img/shapes/waves-white.svg"
                    ...
                    <div
                      ...
                      <img
											...
											src="${pageContext.request.contextPath }/resources/assets/img/illustrations/rocket-white.png"
											alt="rocket">
                    </div>
                  </div>
                </div>
        ...
        <div class="col-lg-5">
          <div class="card h-100 p-3">
            <div
						...
						style="background-image: url('${pageContext.request.contextPath }/resources/assets/img/ivancik.jpg');">
          ...
          <div class="card z-index-2">
            <div class="card-body p-3">
              ...
              <p class="text-sm ms-2"> (<span
								class="font-weight-bolder">+23%</span>) than last week </p>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img
														src="${pageContext.request.contextPath }/resources/assets/img/small-logos/logo-xd.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img
														src="${pageContext.request.contextPath }/resources/assets/img/small-logos/logo-atlassian.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img
														src="${pageContext.request.contextPath }/resources/assets/img/small-logos/logo-slack.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img
														src="${pageContext.request.contextPath }/resources/assets/img/small-logos/logo-spotify.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img
														src="${pageContext.request.contextPath }/resources/assets/img/small-logos/logo-jira.svg"
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img
														src="${pageContext.request.contextPath }/resources/assets/img/small-logos/logo-invision.svg"
              ...
              <div class="timeline timeline-one-side">
                <div class="timeline-block mb-3">
                  ...
                  <div class="timeline-content">
                    ...
                    <p
										class="text-secondary font-weight-bold text-xs mt-1 mb-0">22 DEC 7:20 PM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                  ...
                  <div class="timeline-content">
                    ...
                    <p
										class="text-secondary font-weight-bold text-xs mt-1 mb-0">21 DEC 11 PM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                  ...
                  <div class="timeline-content">
                    ...
                    <p
										class="text-secondary font-weight-bold text-xs mt-1 mb-0">21 DEC 9:34 PM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                  ...
                  <div class="timeline-content">
                    ...
                    <p
										class="text-secondary font-weight-bold text-xs mt-1 mb-0">20 DEC 2:20 AM</p>
                  </div>
                </div>
                <div class="timeline-block mb-3">
                  <span class="timeline-step">
                  ...
                  <div class="timeline-content">
                    ...
                    <p
										class="text-secondary font-weight-bold text-xs mt-1 mb-0">18 DEC 4:54 AM</p>
                  </div>
                </div>
                <div class="timeline-block">
                  ...
                  <div class="timeline-content">
                    ...
                    <p
										class="text-secondary font-weight-bold text-xs mt-1 mb-0">17 DEC</p>
                  </div>
                </div>
              </div>
            </div>
